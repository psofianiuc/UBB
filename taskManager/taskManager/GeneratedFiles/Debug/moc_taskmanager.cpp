...
QT_MOC_LITERAL(1, 12, 18), // "listItemHasChanged"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "taskManager\0listItemHasChanged\0"
};
...
void taskManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->listItemHasChanged(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *taskManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Observer"))
        return static_cast< Observer*>(const_cast< taskManager*>(this));
